...
void LastArea(int rl){
	...
	TD(0,300,11,-100,250,-30,0);
	HM(30,300,11,-50,0,0);
	turn(1,150,11,60,0,0);
	HM(-30,300,10,150,0,0);
	TD(-30,300,01,100,200,-30,0);
	FCC(2,2,0,0);
	ping(1);
	V1(1,0,0,0,0,140,0,240,0,0,0);
	...
	LM(1,300,0,11,0,0,0,0);
	HM(0,300,11,20,-150,0);
	FCC(1,2,0,0);
	turn(1,200,11,90,0,0);
	HM(0,350,10,150,0,0);
	HM(0,350,01,200,150,50);
	TD(0,350,11,300,0,-91,0);
	FCC(1,1,5,250);
	V1(1,0,0,0,0,140,0,240,0,0,0);
	if(C_D[0][0] == PUCK){
		Pm(0,2,2,150,350,10,0,0,400,0,0);
